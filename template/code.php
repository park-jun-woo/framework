    ...
    "admin"=>[
        ...
        "/login"=>[
            "post"=>[
                "permission"=>["admin"],
                "code"=>[
                    ["method"=>"validate","exit"=>"yes","entity"=>"members","value"=>["id","password"]],
                    ...
                    ["method"=>"try","count"=>5,"period"=>3600,"value"=>["message"=>["ko"=>"로그인 5회 틀렸습니다."]]],
                    ["method"=>"password","exit"=>"yes","value"=>["result.member=password"=>["ko"=>"아이디가 없거나 비밀번호가 틀렸습니다."]]],
